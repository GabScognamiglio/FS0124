...
while (ciclo < starWarsCharacters.length) {
  crewMass += starWarsCharacters[ciclo].mass
  ciclo++
}
...
else if (crewMass <= 700) { console.log("Ship is half loaded") }
else if (crewMass <= 900) { console.log("Warning: Load is over 700") }
else if (crewMass <= 1000) { console.log("Critical Load: Over 900") }
